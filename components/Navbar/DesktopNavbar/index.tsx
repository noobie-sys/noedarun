...
import { navBarTextAnimation } from '@/Animations/textAnimation';
...
const NavbarDestop =  () => {
  ...
  return (
    <div className=" relative z-50  flex justify-center gap-10 text-lg items-center">
        <motion.div variants={navBarTextAnimation} initial="initial" animate="animate" className={`flex  w-full parnt-div ${pathname === "/products/"+params.slug ? "text-white" : "text-color"}`}>
