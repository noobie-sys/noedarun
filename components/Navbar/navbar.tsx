...
export const Navbar = () => {
  ...
  return (
    <nav className="w-full px-10 flex items-center justify-between relative">
      <div className="logo   flex justify-center items-center">
        <Link href={"/"} className="relative z-10">
          <svg
            ...
            aria-hidden="true"
            className="w-24 h-24 fill-black dark:fill-slate-50"
          >
      ...
      <div className="hidden   lg:flex justify-center gap-10 text-lg items-center main-link-div">
        <div className="flex gap-10 link-hover">
          <div className="relative z-10 text-hover  ">
            <Link
              href="/"
              className="textHoverEffect relative mix-blend-mode "
              data-text="Men"
            >
              Men
            </Link>
          ...
          <div className="relative z-10">
            <Link
              href="/"
              className="textHoverEffect text-hover"
              data-text="Women"
            >
              Women
            </Link>
          ...
          {/* // Hover MegaMenu Effect  */}
        </div>
        <div className="relative">
          <Link href="/" className="textHoverEffect other ">
            Other
          </Link>
        </div>
      </div>
      ...
      <AnimatePresence mode="wait">
        {open.open && <MobileNav />}
        {/* {isHovered && <Nav />} */}
        <motion.div className="submenu fixed top-0 left-0 w-full bg-black h-[60vh]">
          <Nav />
        </motion.div>
      </AnimatePresence>
    </nav>
